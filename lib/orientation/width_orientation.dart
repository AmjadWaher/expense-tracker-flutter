...
class WidthOrientation extends StatefulWidget {
  const WidthOrientation({super.key, required this.addExpense});
  final void Function(Expense) addExpense;
  @override
  State<WidthOrientation> createState() {
    return _WidthOrientationState();
  }
}

class _WidthOrientationState extends State<WidthOrientation> {
